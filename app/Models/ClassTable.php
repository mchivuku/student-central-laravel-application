...
class ClassTable extends BaseModel
{
    ...
    public function scopeCustomOrderBy($query, $term)
    {
        ...
        if (substr($term, 5, 1) == 5)
            ...
            return $query->orderByRaw('ACAD_GRP_CD, CRS_SUBJ_DEPT_CD, CLS_DRVD_SESN_CD,  SUBSTR(CRS_ATTRIB_VAL_CD, 1, 2) DESC, CRS_ATTRIB_VAL_CD, CRS_CATLG_NBR, CRS_SUBJ_LTR_CD, CLS_ASSCT_NBR, CLS_DRVD_GRD_CMPNT_IND DESC,
 CRS_CMPNT_CD, CLS_DRVD_SORT_CD, CLS_MTG_STRT_TM_sec, CLS_NBR, CLS_DRVD_SORT_CD, CLS_MTG_STRT_TM_sec, CLS_MTG_PTRN_NBR, CLS_INSTR_ASGN_SEQ_NBR
        ...
        return $query->orderByRaw('ACAD_GRP_CD,  CRS_SUBJ_DEPT_CD, SUBSTR(CRS_ATTRIB_VAL_CD, 1, 2) DESC, CRS_ATTRIB_VAL_CD, CRS_CATLG_NBR, CRS_SUBJ_LTR_CD, CLS_ASSCT_NBR, CLS_DRVD_GRD_CMPNT_IND DESC,
                          CRS_CMPNT_CD, CLS_DRVD_SORT_CD, cls_mtg_strt_tm_sec, CLS_NBR, CLS_DRVD_SORT_CD, cls_mtg_strt_tm_sec, CLS_MTG_PTRN_NBR, CLS_INSTR_ASGN_SEQ_NBR
	           ');
